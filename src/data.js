...
export const experiences = [
  ...
  {
    title: "Coral",
    subtitle: "HackDuke Winner: Education Track (2020)",
    description:
...
export const jobs = [
  ...
  },
  {
    ...
    image: "./images/wdas.jpg",
    mediaType: "image",
    skills: "Python, USD (Universal Scene Description), 3D Animation Pipeline, React, Plotly, d3.js"
  },
  {
    ...
    description:
      "Analyzed sentiment dispersion trends and keyword phrasing across 20 years of communications data using Python (Pandas, Plotly), SQL, and Natural Language Processing (NLP) models, collaborating with Markets and Tech teams. Uncovered gaps in training data by creating data visualizations that led to expedited NLP model improvements.",
    image: "./images/research.png",
    mediaType: "image",
    skills: "Python, SQL, NLP, React, Plotly"
  }
];
